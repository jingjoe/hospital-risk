...
$this->title = 'ทบทวนความเสี่ยง risk มาถึงคุณ';
...
<div class="riskregister-index">
    ...
    <?= GridView::widget([
            ...
            'exportConfig' => [
                   GridView::CSV => ['label' => 'Export as CSV', 'filename' => 'riskreview_touse'.date('Y-d-m')],
                   GridView::PDF => ['label' => 'Export as PDF', 'filename' => 'riskreview_touse'.date('Y-d-m')],
                   GridView::EXCEL=> ['label' => 'Export as EXCEL', 'filename' => 'riskreview_touse'.date('Y-d-m')],
                   GridView::TEXT=> ['label' => 'Export as TEXT', 'filename' => 'riskreview_touse'.date('Y-d-m')],
                ],
        // set your toolbar
            'toolbar' =>  [
                ['content' => 
                    Html::a('<i class="glyphicon glyphicon-repeat"></i>', ['riskreview/touse'], ['data-pjax' => 0, 'class' => 'btn btn-default', 'title' => Yii::t('app', 'รีเซ็ต')])
                ],
                '{toggleData}',
                '{export}',
            ],
...
//                ], 
                ...
                'buttons'=>[
                    'view'=>function ($url, $model2,$key) {
                        return Html::a('<i class="glyphicon glyphicon-eye-open"></i> เปิดดู', ['riskregister/viewuse', 'id' => $model2->id,'id_risk' => $model2->id_risk], ['class' => 'btn btn-success btn-xs']);
                    },
